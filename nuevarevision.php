			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="guardadatosrevision.php" enctype="multipart/form-data" method="POST" name="nueva_revision">
							
								<div class="form-group">
									<label>Fecha</label>
									<input class="form-control" placeholder="Fecha" name="fecha">
								</div>

								<div class="form-group">
									<label>Numero de Revisión</label>
									<input class="form-control" placeholder="Numero de Revisión" name="num_rev">
								</div>

								<div class="form-group">
									<label>Evaluacion</label>
									<input class="form-control" placeholder="Evaluacion" name="evaluacion">
								</div>

								<div class="form-group">
									<label>Id Formulario</label>
									<input class="form-control" placeholder="Id Formulario" name="id_formulario_protocolo">
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control" placeholder="Id Revisor" name="id_revisor">
								</div>
