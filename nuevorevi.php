	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class=""><a href="formrevi.php">Revisor</a></li>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="guardadatosrevisor.php" enctype="multipart/form-data" method="POST" name="nuevo_revisor">
							

								<div class="form-group">
									<label>Numero de Trabajador</label>
									<input class="form-control" placeholder="Numero de Trabajador" name="num_trabajador">
								</div>
								...
								<div class="form-group">
									<label>Sexo</label>
									<input class="form-control" placeholder="Sexo" name="sexo">
								</div>


								<div class="form-group">
									<label>Linea de Investigación</label>
									<input class="form-control" placeholder="Linea de Investigacion" name="linea_de_investigacion">
								</div>
