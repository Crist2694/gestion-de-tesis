						...
						<table  class="table table-hover" >
						    ...
						    <tbody>
								...
								<tr>
									...
									<td> <a href="modadmin.php?id_admin=<?php echo $row['id_admin'];?>"" class="btn btn-info btn-lg ">
          <span class="glyphicon glyphicon-heart-empty"></span>   </a></td>
          							<td> <a href="eli_admin.php?num_trabajador=<?php echo $row['num_trabajador'];?>" class="btn btn-info btn-lg btn-danger">
          <span class="glyphicon glyphicon-remove"></span>
        </a></td>
								</tr>

								<?php } ?>
								<tr><a href="nuevoadmin.php"class="btn btn-info btn-lg btn-success">
