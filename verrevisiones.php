		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Revisiones</div>
					<div class="panel-body">
						<table  class="table table-hover" >
						    ...
						    <tr>
						        ...
						        <th data-field="name" data-sortable="true">Numero de Revision</th>
						       
						        <th data-field="state" data-checkbox="true">Evaluación</a></th>
						        <th data-field="state" data-checkbox="true">Id Formulario</a></th>
						        <th data-field="state" data-checkbox="true">Id Alumno</a></th>

						        <th data-field="state" data-checkbox="true">Id Revisor</a></th>
						        <th></th>
						        <th></th>
						    </tr>
						    ...
						    <tbody>
								...
								<tr>
									...
									<td> <?php echo $row['num_rev']; ?></td>
									<td> <?php echo $row['evaluacion']; ?></td>
									<td> <?php echo $row['id_formulario_protocolo']; ?></td>

									<td> <?php echo $row['id_alumno']; ?></td>

									<td> <?php echo $row['id_revisor']; ?></td>

									
									<td> <a href="modrevisiones.php?id_revision=<?php echo $row['id_revision'];?>" class="btn btn-info btn-lg ">
          <span class="glyphicon glyphicon-heart-empty"></span>   </a></td>
          							<td> <a href="mod_formulario.php?id_revision=<?php echo $row['id_revision'];?>" class="btn btn-info btn-lg btn-danger">
          <span class="glyphicon glyphicon-remove"></span>
        </a></td>
								</tr>

								<?php } ?>
								<tr><a href="nuevarevision.php"class="btn btn-info btn-lg btn-success">
