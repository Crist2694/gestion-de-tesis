<?php
	...
	$query="SELECT id_admin, num_trabajador, passwd FROM admin";
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="mod_admin.php?num_trabajador=<?php echo $row['num_trabajador'];?>" enctype="multipart/form-data" method="POST" name="modificar_admin">
							
								<div class="form-group">
									<label>Numero de Trabajador</label>
									<input class="form-control" placeholder="Numero de Trabajador" name="num_trabajador" value="<?php echo $row['num_trabajador'];?>">
								</div>
								...
								<a href="mod_admin.php?num_trabajador=<?php echo $row['num_trabajador'];?>"><button type="submit" class="btn btn-primary">Enviar</a></button>
