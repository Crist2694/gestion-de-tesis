	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>BUAP</span>FCC</a>
				<ul class="user-menu">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="panel panel-blue">
					<div class="panel-heading dark-overlay">
						<a href="loginadmin.html" style="color: #FFFFFF">
					Administrador</a></div>
					<div class="panel-body">
						<p></p>
					</div>
			...
			<div class="col-md-6">
				<div class="panel panel-teal">
					<div class="panel-heading dark-overlay">
						<a href="loginrevisor.html" style="color: #FFFFFF">
					Revisor</a></div>
					<div class="panel-body">
						<p></p>
					</div>
			...
			<div class="col-md-6">
				<div class="panel panel-orange">
					<div class="panel-heading dark-overlay">
						<a href="loginalumno.html" style="color: #FFFFFF">
					Alumno</a></div>
					<div class="panel-body">
						<p></p>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-body tabs">
						...
						<ul class="nav nav-pills">
							<li class="active"><a href="#pilltab1" data-toggle="tab">Admin</a></li>
						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="pilltab1">
								<h4>Administrar datos Admin</h4>
								<a href="admin.php"><input type="submit" name="ir_admin" class="btn btn-primary"> IR</a>
							</div>
